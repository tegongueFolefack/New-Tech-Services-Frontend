...
//     selectedBrands.some((brand) => brand && brand.title === item.brand);

//     const isCategorySelected =
//       selectedCategories.length === 0 ||
//       selectedCategories.some((category) => category && category.title === item.cat);
...
//           Produits de {itemStart} de {Math.min(endOffset, items.length)} de{" "}
//           {items.length}
//         </p>
